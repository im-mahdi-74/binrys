...
def cnn_lstm():
  ...
  model.load_state_dict(torch.load(r'jpy/usdjpy_cnnlstm_v5.pth',weights_only=True))
  return model
...
def lstm():
    ...
    lstm_model.load_state_dict(torch.load(r'jpy/usdjpy_lstm_v5.pth' ,weights_only=True))
    return lstm_model
...
def final_model():
    ...
    model.load_state_dict(torch.load(r'jpy/jpy_metamodel.pth',weights_only=True))
